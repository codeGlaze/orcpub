   ...
   [{:title (str "Thank you for using " branding/app-name "!")
    ...
    {:title "How We Collect Your Information"
     ...
     [{:title "When you give it to us or give us permission to obtain it"
       ...
       [(str "When you sign up for or use our products, you voluntarily give us certain information. This can include your name, profile photo, role-playing game characters, comments, likes, the email address or phone number you used to sign up, and any other information you provide us. If you're using " branding/app-name " on your mobile device, you can also choose to provide us with location data. And if you choose to buy something on " branding/app-name ", you provide us with payment information, contact information (ex., address and phone number), and what you purchased. If you buy something for someone else on " branding/app-name ", you'd also provide us with their shipping details and contact information.")
        (str "You also may give us permission to access your information in other services. For example, if you link your Facebook or Twitter account to " branding/app-name ", which allows us to obtain information from those accounts (like your friends or contacts). The information we get from those services often depends on your settings for that service or their privacy policies, so be sure to check what those are.")]}
    ...
    {:title "How and when do we share information"
     ...
     [(str "Anyone can see the public role-playing game characters and other content you create, and the profile information you give us. We may also make this public information available through what are called \"APIs\" (basically a technical way to share information quickly). For example, a partner might use a " branding/app-name " API to integrate with other applications our users may be interested in. The other limited instances where we may share your personal information include:")
      ...
      (str "Online advertisers typically use third party companies to audit the delivery and performance of their ads on websites and apps. We also allow these companies to collect this information on " branding/app-name ". See Our partners and advertisers.")
    ...
    {:title "Advertising Partners Privacy Policies"
     :font-size 32
     :paragraphs
     [(str "You may consult this list to find the Privacy Policy for each of the advertising partners of " branding/app-name ".Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on " branding/app-name ", which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.Note that " branding/app-name " has no access to or control over these cookies that are used by third-party advertisers")]}
    {:title "Third Party Privacy Policies"
     :font-size 32
     :paragraphs
     [(str branding/app-name "'s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. You may find a complete list of these Privacy Policies and their links here: Privacy Policy Links.You can choose to disable cookies through your individual browser options. To know more detailed information about cookie management with specific web browsers, it can be found at the browsers' respective websites.")]}
    ...
    {:title "Children's Information"
     :font-size 32
     :paragraphs
     [(str "Another part of our priority is adding protection for children while using the internet. We encourage parents and guardians to observe, participate in, and/or monitor and guide their online activity. " branding/app-name " does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.")]}
