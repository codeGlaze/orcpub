              ...
              [:div.main-text-color.flex.justify-cont-c
               [:div.content.f-w-n.f-s-12
                ...
                [:div.flex.justify-cont-s-b.align-items-c.flex-wrap.p-10
                 ...
                 [:div.legal-footer
                  [:p "© 2023 " [:a.orange {:href "https://github.com/Orcpub/orcpub/" :target :_blank} "www.dungeonmastersvault.com"]]
                  [:p "This site is based on " srd-link " - Wizards of the Coast, Dungeons & Dragons, D&D, and their logos are trademarks of Wizards of the Coast LLC in the United States and other countries. © 2023 Wizards. All Rights Reserved."]
