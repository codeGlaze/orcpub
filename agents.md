...
Before making changes, please review the documentation in `docs/`:

- **`docs/CODEBASE.md`** - Project structure, architecture, core concepts, key files
- **`docs/DEVELOPER_ONBOARDING.md`** - Props vs modifiers, plugin system, technical patterns
- **`docs/analysis/`** - Exploratory analysis and design decisions (for context on edge cases)

Essential reading:
- Entity/Template/Modifier system (the heart of OrcPub)
- Props vs Modifiers architecture
- Plugin system and serialization
...
2. **Understand Context**: Review `docs/CODEBASE.md` for architectural context
...
- Check `docs/CODEBASE.md` for detailed structure information

### Before You Start
1. Review `docs/CODEBASE.md` for codebase overview
...
- Check `docs/CODEBASE.md` for architecture and structure details
