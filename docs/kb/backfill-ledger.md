...
| `mod5e/ac-bonus-fn` (modifiers) | `mod5e/ac-bonus` — same channel, requirements as data | 2026-09-08 | 2026-12-08 | `ac_reconciliation` parity sweep; `bracers_ac_test` | **Struck** (`#_`); zero live callers — the 5 remaining sites are inside `#_` UA blocks |
