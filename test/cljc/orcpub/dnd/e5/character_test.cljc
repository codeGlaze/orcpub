(ns orcpub.dnd.e5.character-test
  (:require [clojure.spec.alpha :as spec]
            #?(:clj [clojure.spec.alpha.test :as stest])
...
#?(:clj (stest/instrument `char5e/standard-ability-rolls))
#?(:clj (char5e/standard-ability-rolls))
#?(:clj (stest/summarize-results (stest/check `char5e/standard-ability-rolls)))
