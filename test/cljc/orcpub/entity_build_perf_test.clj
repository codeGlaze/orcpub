(ns orcpub.entity-build-perf-test
  ...
  (:require [clojure.test :refer [deftest testing is]]
            ...
            [orcpub.dnd.e5.ac-reconciliation-test :as act]
...
;; ---------------------------------------------------------------------------
;; The real graph: exactly what `apply-options` hands to `kahn-sort` for the
;; barbarian/monk/homebrew-race character the perf work is measured against.
;; ---------------------------------------------------------------------------
...
(def real-graph
  (all-deps-for (act/entity-with act/abilities [:barbarian :monk :liz-]) act/test-template))
